...
fun ItemScreen(
    ...
    LazyVerticalGrid(
        ...
        item(
            ...
            Column {
                Image(painter = painterResource(R.drawable.banner2), contentDescription = "Offers Banners", modifier = Modifier.fillMaxWidth())
                Card(
                    ...
                    Text(text = "${stringResource(groUiState.selectedCategory)}(${database.size})", color = Color.White, fontSize = 20.sp, textAlign = TextAlign.Center, modifier = Modifier.padding(horizontal = 10.dp))
                }
            }
        }
...
fun ItemCard(
    ...
    Column(modifier = Modifier.width(150.dp)) {
        ...
        Card(
            ...
            colors = CardDefaults.cardColors(
                containerColor = Color(108, 194, 111, 255) // Green background
            )
        ) {
            Row(
                modifier = Modifier
